...
| **Comment word cloud** | Aggregate frequent terms from synced comment text (stop words removed). | `CommentWordCloudService`, `GET .../comments/word-cloud`; platform-wide: `GET /api/comments/word-cloud` |
