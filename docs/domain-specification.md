...
| **Comment word cloud** | Aggregate frequent terms from synced comment text (PT-BR stop words and HTML stripped). | `CommentWordCloudService`, `GET .../comments/word-cloud`; platform-wide on videos page: `GET /api/comments/word-cloud` |
